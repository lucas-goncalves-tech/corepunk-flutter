...
INSTALL_JS_GLOBAL="C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
