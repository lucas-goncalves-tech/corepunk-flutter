...
ones). Reference: @C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/Drummond/Development/corepunk-flutter/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/Drummond/Development/corepunk-flutter/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/templates/spec.md.
