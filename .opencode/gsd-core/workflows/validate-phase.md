...
```
Agent(
  prompt="Read C:/Users/Drummond/Development/corepunk-flutter/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/templates/VALIDATION.md`
