...
The keys live in `.claude/settings.json` (project) or `C:/Users/Drummond/Development/corepunk-flutter/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
