...
**Verification depth scales with `asvs_level`** (see @C:/Users/Drummond/Development/corepunk-flutter/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
